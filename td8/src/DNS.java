...
public class DNS {
    ...
    public class AdresseIP {
         ...
         * @return true/false
         */
        private boolean check( int reseau ) { return reseau <= 255 & reseau >= 0; }
         ...
         * @return reseau value
         */
        public int getReseau() { return this.reseau; }

        /**
         * Setter: set reseau
         * @param newReseau
         */
        public void setReseau( int newReseau ) { this.reseau = newReseau; }
         ...
         * @param newMask
         */
        public void setMask( int newMask ) { this.mask = newMask; }

        /**
         * Getter: get mask2
         * @return mask value
         */
        public int getMask2() { return this.mask2; }

        /**
         * Setter: set mask2
         * @param newMask2
         */
        public void setMask2( int newMask2 ) { this.mask2 = newMask2; }
         ...
         * @return string
         */
        public String toString() { return this.reseau+"."+this.mask+"."+this.mask2+"."+this.id; }
    ...
    public class Dns {
         ...
         * @param newDataFile
         */
        public void setDataFile( String newDataFile ) { this.dataFile = newDataFile;  }

        /**
         * Getter: get countDataMax
         * @return countDataMax value
         */
        public int getCountDataMax() { return this.countDataMax; }

        /**
         * Setter: set countDataMax
         * @param newCountDataMax
         */
        public void setCountDataMax( int newCountDataMax ) { this.countDataMax = newCountDataMax; }

        /**
         * Getter: get IpToNomMachine
         * @return IpToNomMachine HashMap
         */
        public HashMap<AdresseIP, NomMachine> getIpToNomMachine() { return this.IpToNomMachine; }
         ...
         */
        public HashMap<NomMachine, AdresseIP> getNomMachineToIp() { return this.NomMachineToIp; }
    ...
    public class DnsItem{
         ...
         * @return machine
         */
        public NomMachine getMachine() { return this.machine; }

        /**
         * Setter: set NomMachine machine
         * @param newMachine
         */
        public void setMachine( NomMachine newMachine ) { this.machine = newMachine; }
         ...
         * @param newip
         */
        public void setIp( AdresseIP newip ) { this.ip = newip; }

        /**
         *
         */
        public String toString() { return this.ip.toString()+" => "+this.machine.toString(); }
    }
    ...
    public class ExeCmd implements Command {
        ...
        public String execute() throws IOException
        {
            ...
            if( this.cmdExe.equals("NomMachineToIp") )
                return support.getItem( support.strToNomMachine( this.arg ) ).getIp().toString();

            else if( this.cmdExe.equals("IpToNomMachine") )
                return support.getItem( support.strToAdresseIP( this.arg ) ).getMachine().toString();

            else if( this.cmdExe.equals("Domain") )
    ...
    public class DnsTUI{
         ...
         * @param newArg
         */
        public void setArg( String newArg  ) { this.arg = newArg; }

        /**
         *
         * @param res
         */
        public void print( String res ) { System.out.println( res ); }
        ...
        public void nextCommand() throws IOException{
            ...
            // Maybe 'ls [-a] domain'
            else if (this.arg.contains("ls [-a]")) {
                String tmp = this.arg.substring(7, this.arg.length());

                this.exe.setCmdExe("Domain");
                this.exe.setArg(this.arg);
                print(this.exe.execute());
            }
